document.addEventListener("DOMContentLoaded", function() {
    ...
    $(".confirmar").submit(function(e) {
        e.preventDefault();
        Swal.fire({
            title: 'Ingrese la clave para confirmar la eliminación:',
            input: 'password',
            ...
            if (result.isConfirmed) {
                ...
                const claveCorrecta = '12345'; // Clave de acceso

                if (claveIngresada === claveCorrecta) {
                    // Si la clave es correcta, se envía el formulario
                    Swal.fire('Clave correcta', '', 'success').then(() => {
                        this.submit(); // Envía el formulario
                    });
                } else {
                    // Si la clave es incorrecta, muestra un mensaje de error
                    Swal.fire('Clave incorrecta', 'Por favor, ingrese la clave correcta para confirmar la eliminación.', 'error');
                }
            }
        })
